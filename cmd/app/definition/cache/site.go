...
const DefSiteRepository = "repo.cache.site"
	...
	container.Register(func(builder *container.Builder, params map[string]interface{}) error {
		builder.AddDefinition(container.Definition{
			...
			Build: func(ctx container.Context) (_ interface{}, err error) {
				...
				var repo postgres.SiteRepository
				if err = ctx.Fill(postgres.DefSiteRepository, &repo); err != nil {
					return nil, err
				}
				...
				return cache.NewSite(kvFactory(), repo), nil
			},
		})
